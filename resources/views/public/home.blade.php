			...
			<div class="row m-rl--1">
				@if($featuredNews->count() > 0)
					<div class="col-md-6 p-rl-1 p-b-2">
						<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url({{ $featuredNews->first()->thumbnail ? asset('storage/' . $featuredNews->first()->thumbnail) : 'https://placehold.co/600x400/E8E8E8/A7A6A6.png?text=Post+Thumbnail' }});">
						...
						<div class="row m-rl--1">
							@if($featuredNews->count() > 1)	
								<div class="col-12 p-rl-1 p-b-2">
									<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url({{ $featuredNews[1]->thumbnail ? asset('storage/' . $featuredNews[1]->thumbnail) : 'https://placehold.co/600x400/E8E8E8/A7A6A6.png?text=Post+Thumbnail' }});">
							...
							@if($featuredNews->count() > 2)
								<div class="col-sm-6 p-rl-1 p-b-2">
									<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ $featuredNews[2]->thumbnail ? asset('storage/' . $featuredNews[2]->thumbnail) : 'https://placehold.co/600x400/E8E8E8/A7A6A6.png?text=Post+Thumbnail' }});">
							...
							@if($featuredNews->count() > 3)
								<div class="col-sm-6 p-rl-1 p-b-2">
										<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ $featuredNews[3]->thumbnail ? asset('storage/' . $featuredNews[3]->thumbnail) : 'https://placehold.co/600x400/E8E8E8/A7A6A6.png?text=Post+Thumbnail' }});">
								...
								<div class="col-sm-6 p-r-25 p-r-15-sr991">
									...
									<div class="m-b-45">
										<a href="{{ route('news.show', $news->slug) }}" class="wrap-pic-w hov1 trans-03">
											<img src="{{ $news->thumbnail ? asset('storage/' . $news->thumbnail) : 'https://placehold.co/600x400/E8E8E8/A7A6A6.png?text=Post+Thumbnail' }}" alt="{{ $news->title }}">
										</a>
