			...
			<div class="row m-rl--1">
				@if($featuredNews->count() > 0)
					<div class="col-md-6 p-rl-1 p-b-2">
						<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url({{ $featuredNews->first()->image_url ?? 'images/post-01.jpg' }});">
						...
						<div class="row m-rl--1">
							@if($featuredNews->count() > 1)
								<div class="col-12 p-rl-1 p-b-2">
									<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url({{ $featuredNews[1]->image_url ?? 'images/post-02.jpg' }});">
							...
							@if($featuredNews->count() > 2)
								<div class="col-sm-6 p-rl-1 p-b-2">
									<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ $featuredNews[2]->image_url ?? 'images/post-03.jpg' }});">
							...
							@if($featuredNews->count() > 3)
								<div class="col-sm-6 p-rl-1 p-b-2">
									<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ $featuredNews[3]->image_url ?? 'images/post-04.jpg' }});">
